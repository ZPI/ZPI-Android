...
public enum DialogsEnum {
	SelectThisTraining(R.string.trening_plan_select_title, R.string.trening_plan_select_message, android.R.string.yes,
		...
		R.string.trening_plan_confirm_disable_message, android.R.string.ok), CheckTTS(
		R.string.no_tts_dialog_check_title, R.string.no_tts_dialog_check_message, android.R.string.ok), NoTTSData(
		R.string.no_tts_dialog_title, R.string.no_tts_dialog_message, android.R.string.yes, android.R.string.no);
